...
<?php include("inc-header.php"); ?>
		<div class="px-3 py-3 mx-auto mb-3 text-center text-dark bg-light">
<p class="text-kviz-dark font-weight-bold h5">Ha bármilyen, probléma merülne fel az oldal használata közben, vagy valamilyen kivetnivalót találsz valamelyik kvízben az alábbi e-mail címen tudsz elérni engem. Igyekszem majd minél hamarabb orvosolni a problémát.</p>
<p class="text-kviz-dark font-weight-bold h5">panasz@ekviz.hu</p>
		</div>
